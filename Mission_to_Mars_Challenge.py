...
browser.quit()
#Note: Live sites are a great resource for fresh data, but the layout of the site may be updated or 
#otherwise changed. When this happens, there's a good chance your scraping code will break and need 
#to be reviewed and updated to be used again.
